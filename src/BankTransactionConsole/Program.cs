...
namespace BankTransactionConsole {
    class Program {
        ...
        static AccountSummary GetBalanceMQ () {
            ...
            if (String.IsNullOrEmpty (repMessage.Content)) return null;
            return JsonConvert.DeserializeObject<AccountSummary> (repMessage.Content);
        }
        static AccountTransactionResponse DepositMQ (AccountTransaction tranx) {
            var message = new TransactionMessage (client.DefaultRequestHeaders.Authorization.ToString (),
                MessageCode.Deposit,
        ...
        static AccountTransactionResponse WithdrawMQ (AccountTransaction tranx) {
            var message = new TransactionMessage (client.DefaultRequestHeaders.Authorization.ToString (),
